...
open import Gregorianum.YearMonth.Properties using (¬isSuc-unique; next-unique; prev-unique; ⋖-wellFounded; ∃prev⇒IsSuc; suc-ordinal⇒IsSuc; prev-ordinal; next-ordinal; ⋖-irrelevant)
...
open import Gregorianum.YearMonth.Timeline using (isTimeline)
