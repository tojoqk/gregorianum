...
nextYear-plain : ∀ {y₁ y₂ n} → y₁ ⋖ y₂ → y₁ HasPlain n → y₂ HasPlain (suc n)
nextYear-plain step plain = plain
nextYear-plain step₄ plain = plain
nextYear-plain step₁₀₀ plain = plain
nextYear-plain step₄₀₀ plain = plain

prevYear-plain : ∀ {y₁ y₂ n} → y₁ ⋖ y₂ → y₂ HasPlain (suc n) → y₁ HasPlain n
prevYear-plain step plain = plain
prevYear-plain step₄ plain = plain
prevYear-plain step₁₀₀ plain = plain
prevYear-plain step₄₀₀ plain = plain
...
... | y₁' , y₁'⋖y₁ | y₂' , y₂'⋖y₂ with year-unique {y₁'} {y₂'} {n} (prevYear-plain y₁'⋖y₁ p) (prevYear-plain y₂'⋖y₂ q)
